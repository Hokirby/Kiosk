...
public class Main {
    public static void main(String[] args) {
        ...
        Burgers burger3 = new Burgers("Hamburger", 5.4, "비프패티를 기반으로 야채가 들어간 기본버거");
        menu.menuItems[0].add(burger1);
        menu.menuItems[0].add(burger2);
        menu.menuItems[0].add(burger3);
        ...
        menu.menuItems[1].add(drink1);
        menu.menuItems[1].add(drink2);
        menu.menuItems[1].add(drink3);
        Deserts desert1 = new Deserts("IceCream", 0.5, "바닐라 아이스크림");
        Deserts deserts2 = new Deserts("Tornado", 2.5, "초콜릿 시럽이 뿌려진 바닐라 아이스크림");
        menu.menuItems[2].add(desert1);
        menu.menuItems[2].add(deserts2);
